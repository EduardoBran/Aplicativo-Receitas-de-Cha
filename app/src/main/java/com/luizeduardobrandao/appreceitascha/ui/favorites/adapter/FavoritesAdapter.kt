...
/**
 * Adapter da lista de receitas favoritas.
 *
 * - Exibe title + subtitle.
 * - Ícone de "ir" navega para detalhes.
 */
class FavoritesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesViewHolder {
        ...
        return FavoritesViewHolder(binding, onOpenRecipe)
    }
    ...
    class FavoritesViewHolder(
        ...
        fun bind(recipe: Recipe) {
            ...
            // Card inteiro também pode abrir a receita, se desejar:
            binding.cardFavoriteRoot.setOnClickListener {
                onOpenRecipe(recipe)
            }

            binding.imageButtonOpenRecipe.setOnClickListener {
                onOpenRecipe(recipe)
            }
        }
    }
